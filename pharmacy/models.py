...
class NewNumberOfItem(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, verbose_name='الرمز التسلسلي')
...
class Item(models.Model):
    ...
    size = models.ForeignKey(NewSize,related_name='itemSize', on_delete=models.CASCADE)
#    description = models.TextField(null=True, blank=True,verbose_name='الوصف')
    sourcePrice= models.ForeignKey(NewPrice,related_name='sourcePrice', on_delete=models.CASCADE)
    numberOfItem= models.ForeignKey(NewNumberOfItem,related_name='numberOfItem', on_delete=models.CASCADE)
    itemPrice= models.ForeignKey(NewPrice,related_name='itemPrice', on_delete=models.CASCADE)
...
class ShoppingBill(models.Model):
    ...
    requestDate = models.DateTimeField(verbose_name='تاريخ الطلب')
...
#    bill=models.ForeignKey(ShoppingBill,related_name='shoppingItem', on_delete=models.CASCADE)
#    def __str__(self):
#        return f'{self.itemName}'
